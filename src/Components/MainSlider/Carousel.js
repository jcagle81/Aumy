...
class Deck extends Component {
    constructor(props) {
        ...
        this.state = {
            cards: [
                <Card picsum={`./one.jpg`} id="one" key="one" />,
                <Card picsum={`./two.jpg`} id="two" key="two" />,
                <Card picsum={`./three.jpg`} id="three" key="three" />,
                <Card picsum={`./four.jpg`} id="four" key="four" />
            ]
        }
    }
